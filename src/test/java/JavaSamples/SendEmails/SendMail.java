package JavaSamples.SendEmails;
...
public class SendMail {
    ...
    public static void main(String[] args) throws MessagingException {
        //Recipient's Mail id
        String receipientTo = "DimuthuR@mitesp.com";
        //Sender's Mail id
        String senderFrom = "mitespqa@gmail.com";
        //Path of PDF test report
        String path = "C:\\Users\\DimuthuR\\Desktop\\Today.txt";
        ...
        transport.connect("smtp.gmail.com",465,"mitespqa@gmail.com","1qaz2wsx@");
