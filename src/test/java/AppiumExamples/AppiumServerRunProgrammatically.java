...
//This is how to start and stop appium server programmatically
public class AppiumServerRunProgrammatically {
    ...
    public void openApp() throws MalformedURLException
    {
        ...
        driver = new AppiumDriver (new URL("http://127.0.0.1:4890/wd/hub"), capabilities);
